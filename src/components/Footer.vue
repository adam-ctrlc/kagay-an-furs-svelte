<template>
  <footer class="bg-primary/90 border-t-2 border-border-base py-12">
    <div
      class="max-w-5xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10"
    >
      <!-- Logo & Tagline -->
    ...
    <div class="border-t border-white/20 py-4">
      <p class="text-center text-sm text-white">
        © {{ new Date().getFullYear() }} KFM. All rights reserved.
      </p>
    </div>
  </footer>
</template>
